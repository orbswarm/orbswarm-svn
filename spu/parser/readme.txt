...
test.y: a test grammar (Lemon input)

testharness.c: contains the main() and code to test the parser generated by test.y. It is 
concatenated with test.c (Lemon output) and compiled to give a test program that reads from stdin. 
See the makefile. 
