...
LIBS := -lm -static
INCLUDES :=
OBJS := mrqmin.o eval_camera.o kalman_camera.o kalman.o matmath.o random.o test.o
SRCS := mrqmin.c eval_camera.c kalman_camera.c kalman.c matmath.c random.c test.c
HDRS := matmath.h kalman.h test.h
