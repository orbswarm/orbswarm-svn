Last updated 11 September 2010 by Robert Harris, orbswarm.com@trebor.org.
...
which is the read me included with distributions.

-------------------------------------------------------------------------------

Copyright (C) 2010 Robert B. Harris (orbswarm.com@trebor.org).  This
package is released files released under the terms the MIT license:

   http://www.opensource.org/licenses/mit-license.php

The text of the MIT license appears in the mit-license.txt file.
