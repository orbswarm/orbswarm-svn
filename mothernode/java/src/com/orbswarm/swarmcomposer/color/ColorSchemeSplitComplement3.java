 ...
 */
public class ColorSchemeSplitComplement3 extends ColorScheme {
    ...
    */
    ...
    private void recalculate() {
        ...
        swatches[1].setHue(angleToHue(baseAngle - spreadAngle));
        swatches[2].setHue(angleToHue(baseAngle + spreadAngle + (float)Math.PI));
        swatches[3].setHue(angleToHue(baseAngle + (float)Math.PI));
        swatches[4].setHue(angleToHue(baseAngle - spreadAngle + (float)Math.PI));
    }
}