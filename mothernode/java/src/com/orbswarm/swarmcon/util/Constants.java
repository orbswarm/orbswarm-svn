...
public class Constants
{
  ...
  public static final Font BUTTON_FONT = new Font("Lucida Grande",
    Font.PLAIN, 40);
  ...
  /**
   * The offset between internal orb IDs (0-5) and actual orb IDs (60 - 65)
   */
  ...
  public static final String PROPERTIES_FILE_LOCATION = System
  ...
  public static final NumberFormat HEADING_FORMAT = NumberFormat
    .getNumberInstance();
  public static final NumberFormat UTM_FORMAT = NumberFormat
    .getNumberInstance();
