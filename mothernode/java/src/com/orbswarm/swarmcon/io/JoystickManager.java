...
/**
 * JoystickManager provides access to joystick events. The JoystickManager
 * also is a vector of StickInfo, so it functions as it's own database of
...
public class JoystickManager extends Vector<JoystickManager.StickInfo>
{
  ...
  HashMap<Integer, Listeners> filteredListeners = new HashMap<Integer, Listeners>();

  /**
   * Construct a joystick object which starts an independent joystick
   * monitoring thread.
   */
  ...
  /**
   * Register a Listener which handels joystick events from all joysticks.
   * 
   * @param listener the joystick listener which will recieve joystick
   *        events
   */
  ...
  /**
   * Register a Listener which handles joystick events from a particular
   * joystick.
   * 
   * @param listener the joystick listener which will recieve joystick
   *        events
  ...
  public static class StickInfo
  {
    ...
    public StickInfo(int number, int buttons, int axes, int hats, String name)
    {
      this.number = number;
    ...
    /**
     * Get this joystick's number, which is just a unique identifer for the
     * joystick.
     * 
    ...
    {
      return "joystick: " + number + " buttons: " + buttons + " axes: " +
        axes + " hats: " + hats + " name: \"" + name + "\"";
    }
  }
  ...
  public static void main(String[] args)
  {
    ...
    Listener jl = new Listener()
    {
      ...
      {
        log.debug("stick: " + stick + " axis: " + axis + " value: " + value);
      }
      ...
      {
        log.debug("stick: " + stick + " hat: " + hat + " x: " + x + " y: " +
          y);
      }
      ...
      {
        log.debug("stick: " + stick + " button: " + button + " press: 1");
      }
      ...
      {
        log.debug("stick: " + stick + " button: " + button + " press: 0");
      }
